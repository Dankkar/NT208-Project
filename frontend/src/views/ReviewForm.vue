              ...
              <form @submit.prevent="submitReview">
                ...
                <div class="mb-4">
                  ...
                  <div class="d-flex align-items-center gap-3 mb-2">
                    ...
                    <span class="text-muted small">{{ getRatingText(rating) }}</span>
                  </div>
                ...
                <!-- Review Content -->
                <div class="mb-4">
                  <label for="reviewContent" class="form-label fw-bold">Chi tiết đánh giá</label>
                  <textarea 
                    id="reviewContent"
                ...
                <!-- Quick Rating Categories (Optional) -->
                <div class="mb-4">
                  <label class="form-label fw-bold">Đánh giá chi tiết (tùy chọn)</label>
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <label class="form-label small">Chất lượng phòng</label>
                      <div class="star-rating small">
                        <span 
                          v-for="star in 5" 
                          :key="`room-${star}`"
                          class="star"
                          :class="{ 'filled': star <= detailRatings.room }"
                          @click="detailRatings.room = star"
                        >
                          <i class="bi bi-star-fill"></i>
                        </span>
                      </div>
                    ...
                    <div class="col-md-6 mb-3">
                      <label class="form-label small">Dịch vụ khách hàng</label>
                      <div class="star-rating small">
                        <span 
                          v-for="star in 5" 
                          :key="`service-${star}`"
                          class="star"
                          :class="{ 'filled': star <= detailRatings.service }"
                          @click="detailRatings.service = star"
                        >
                          <i class="bi bi-star-fill"></i>
                        </span>
                      </div>
                    ...
                    <div class="col-md-6 mb-3">
                      <label class="form-label small">Vệ sinh</label>
                      <div class="star-rating small">
                        <span 
                          v-for="star in 5" 
                          :key="`clean-${star}`"
                          class="star"
                          :class="{ 'filled': star <= detailRatings.cleanliness }"
                          @click="detailRatings.cleanliness = star"
                        >
                          <i class="bi bi-star-fill"></i>
                        </span>
                      </div>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <div class="star-rating small">
                        <span 
                          ...
                          :key="`location-${star}`"
                          class="star"
                          :class="{ 'filled': star <= detailRatings.location }"
                          @click="detailRatings.location = star"
                        >
                          <i class="bi bi-star-fill"></i>
                        </span>
                      </div>

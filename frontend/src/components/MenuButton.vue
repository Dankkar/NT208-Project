  ...
  <div>
    ...
    <teleport to="body">
      <transition name="slide">
        ...
        >
          <nav class="sidebar" @click.stop> <!-- @click.stop để không bị closeMenu khi click vào sidebar -->
...
import Button from './Button.vue'; // Giả sử Button.vue nằm cùng thư mục

const show = ref(false);
const items = ['Stay', 'Shop', 'Dine', 'See & Do'];
...
const handleMenuItemClick = () => {
  // Thêm logic điều hướng hoặc hành động khác tại đây
  // console.log('Menu item clicked');
  closeMenu(); // Đóng menu sau khi click item
};
